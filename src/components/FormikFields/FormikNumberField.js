...
const FormikNumberField = (props) => {
  ...
  const showErrorMessage = (msg) => {
    // console.log(msg.slice(0, 6), 'message÷eee')
    let modifiedMsg = msg.slice(0, 6) === 'tasks['? 'Hours must be greater than 0' : msg;
    return <div style={{ color: "red ", textAlign: 'left' }}>{modifiedMsg}</div>;
  };
...
//   console.log(touched, name, errors, 'props')
